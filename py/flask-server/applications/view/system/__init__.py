...
from applications.view.system.photo import bp as photo_bp
...
from applications.view.system.excel import bp as excel_bp
...
def register_system_bps(app: Flask):
    ...
    system_bp.register_blueprint(photo_bp)
    system_bp.register_blueprint(excel_bp)
