...
const ::uint32_t
    TableStruct_login_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        PROTOBUF_FIELD_OFFSET(::login::LoginRequest, _impl_.pass_),
};
...
const char descriptor_table_protodef_login_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "name\030\001 \001(\t\022\014\n\004pass\030\002 \001(\tb\006proto3"
};
...
const ::_pbi::TcParseTable<1, 2, 0, 35, 2> LoginRequest::_table_ = {
  {
    ...
    {::_pbi::TcParser::FastUS1,
     {18, 63, 0, PROTOBUF_FIELD_OFFSET(LoginRequest, _impl_.pass_)}},
    // string name = 1;
    {::_pbi::TcParser::FastUS1,
    ...
    // string pass = 2;
    {PROTOBUF_FIELD_OFFSET(LoginRequest, _impl_.pass_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
...
::uint8_t* LoginRequest::_InternalSerialize(
  ...
  if (!this->_internal_pass().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "login.LoginRequest.pass");
...
::google::protobuf::Metadata LoginRequest::GetMetadata() const {
  return ::_pbi::AssignDescriptors(&descriptor_table_login_2eproto_getter,
                                   &descriptor_table_login_2eproto_once,
