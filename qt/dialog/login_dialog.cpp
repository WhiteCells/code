...
LoginDialog::LoginDialog(QWidget *parent) :
    ...
    main_layout_->addWidget(register_btn_, 3, 2);

    this->connect(register_btn_, &QPushButton::clicked,
                  this, &LoginDialog::sig_register_btn_clicked);
}
